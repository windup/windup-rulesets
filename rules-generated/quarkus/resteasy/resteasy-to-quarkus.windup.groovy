...
ruleSet("resteasy-to-quarkus-groovy")
        ...
        .when(SourceMode.isDisabled(),
                ...
                .withProperty(FileModel.FILE_PATH, QueryPropertyComparisonType.REGEX, ".*/javax/servlet\$"))
        .perform(new AbstractIterationOperation<FileModel>() {
            void perform(GraphRewrite event, EvaluationContext context, FileModel payload) {
                final String sourceBasePath = payload.getFilePath().replace("/javax/servlet", "")
                ...
                final String targetFolderPath = sourceBasePath +"/io/quarkus/resteasy/runtime"
                ...
                ((Hint) Hint.titled("Replace the 'jakarta.servlet-api' dependency with Quarkus 'quarkus-resteasy' extension")
                    .withText("""A folder path related to a package from the `jakarta.servlet:jakarta.servlet-api` dependency has been found.  
                                    Replace the `jakarta.servlet:jakarta.servlet-api` dependency with the Quarkus dependency `io.quarkus:quarkus-resteasy` in the application's dependencies management system (Maven, Gradle).  
        ...
        .withId("quarkus-resteasy-groovy-00000")

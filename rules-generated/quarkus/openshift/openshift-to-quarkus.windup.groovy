...
ruleSet("openshift-to-quarkus-groovy")
        .addSourceTechnology(new TechnologyReference("openshift", null))
        ...
        .when(SourceMode.isDisabled(),
                ...
                .withProperty(FileModel.FILE_PATH, QueryPropertyComparisonType.REGEX, ".*/io/fabric8/openshift/client\$"))
        .perform(new AbstractIterationOperation<FileModel>() {
            void perform(GraphRewrite event, EvaluationContext context, FileModel payload) {
                final String sourceBasePath = payload.getFilePath().replaceAll("/io/fabric8/openshift/client\$", "")
                ...
                final String targetFolderPath = sourceBasePath +"/io/quarkus/it/openshift/client/runtime"
                ...
                ((Hint) Hint.titled("Replace the 'openshift-client' dependency with Quarkus 'quarkus-openshift-client' extension")
                    .withText("""A folder path related to a package from the `io.fabric8:openshift-client` dependency has been found.  
                                    Replace the `io.fabric8:openshift-client` dependency with the Quarkus dependency `io.quarkus:quarkus-openshift-client` in the application's dependencies management system (Maven, Gradle).  
        ...
        .withId("quarkus-openshift-client-groovy-00000")

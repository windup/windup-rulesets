...
ruleSet("springboot-generic-unsupported-groovy")
        ...
        .where("artifact").matches("spring-aop|spring-boot-starter-aop|spring-batch-core|spring-boot-starter-batch|spring-cloud-dataflow-core|spring-cloud-skipper|spring-integration-core|spring-boot-starter-integration|spring-ldap-core|spring-boot-starter-data-ldap|spring-mobile-device|spring-boot-starter-mobile|org.springframework.roo.bootstrap")
